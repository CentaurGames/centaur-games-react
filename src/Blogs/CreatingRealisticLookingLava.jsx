...
export function CreatingRealisticLookingLava() {
  return (
    <div className="blog-text">
      <div className="sub-paragraph">
        ...
        <p>
          In order to create this we start with a basic fractal pattern: that of
          a 
          <a href="https://en.wikipedia.org/wiki/Julia_set">Julia set</a>
           whose complex parameter is <em>c</em> = 0 + <em>i</em>. This fractal
          looks as follows when displayed in red:
        </p>
        ...
        <p>
          ...
          image on. Now we simply create a canvas of whatever size we want, give
          it a black background, and draw this image thousands of times at
          random locations on the canvas and rotated at random angles. (See{" "}
          <a href={getBlogUrl("TakingAdvantageOfCanvasRotations")}>this post</a>
