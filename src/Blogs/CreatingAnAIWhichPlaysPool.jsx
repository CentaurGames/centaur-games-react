...
export function CreatingAnAIWhichPlaysPool() {
  ...
  return (
    <div className="blog-text">
      ...
      <div className="sub-paragraph">
        <p>
          In this blog post we will discuss how to develop an AI which can play
          pool against an opponent. For simplicity we will start with a simple
          AI and then modify it into a more sophisticated AI.
        </p>
        <div>
        ...
        <p>
          ...
          only hit the ball straight-on. To make this AI more sophisticated, we
          need it to aim at a pocket.
        </p>
      </div>
      ...
      <div className="sub-paragraph">
        <div>
          ...
          <ul>
            ...
            <li>
              Find the displacement vector from the center of the pocket to the
              center of the ball and extend it by one ball diameter.
            </li>
            <li>
