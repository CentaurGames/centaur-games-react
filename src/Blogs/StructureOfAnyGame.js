    ...
    return (
      <div className="blog-text">
        <div className="sub-paragraph">
          <p>
            In this blog post we will discuss the basic structure of any game.
            Any game can be broken down into six simple steps: image loading,
            rendering, setting event listeners, setting timing intervals,
            resizing the canvas, and loading the audio files.
          </p>
          <p>
          ...
          <ol className="bulleted-list">
            <li>
              <em>Load Images</em>: You should have URLs (or Data URLs) with
              which to load your images. Each image should be given two
              properties: an 
            ...
            <li>
              <em>Set Event Listeners</em>: Any events that are controlled by
              the user should be declared in this function. For those if you who
              are not familiar with{" "}
              <a href="https://www.w3schools.com/jsref/met_element_addeventlistener.asp">
                event listeners
              </a>
              , they are extremely useful when developing games. An event
              listener calls a function whenever some event occurs - e.g. when
              the user clicks the mouse or presses a key.
            </li>
            <li>
            ...
            <li>
              ...
              <a href={getBlogUrl("DynamicResizingOfTheWindow")}>
                previous post
              </a>
