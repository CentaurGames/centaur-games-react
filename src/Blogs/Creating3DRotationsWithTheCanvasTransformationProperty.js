      ...
      <div className="blog-text">
        <div className="sub-paragraph">
          <p>
            ...
            extending this a bit to create realistic rotations in 3D. Examples
            of this effect include the rotating coins in <em>Entombed</em>, 
          ...
          <p>
            ...
            pick up some unphysical traits (this is technically called
            torqueless precession, and it looks super weird).
          </p>
          <p>
            ...
            be multiplied to the left of the rotation matrix <em>R</em>.
          </p>
          <p>
          ...
          <ul className="bulleted-list">
            ...
            <li>
              With each step we multiplied the rotation matrix by three
              elemental rotations.
            </li>
            <li>
          ...
          <p>
            Note that aside from the transformation step, everything else is
            quite similar to the rotations we did in our 
            <a href={getBlogUrl("TakingAdvantageOfCanvasRotations")}>
              previous post
            </a>
            .
