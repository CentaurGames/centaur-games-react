    ...
    return (
      <div className="blog-text">
        <div className="sub-paragraph">
          <p>
            When creating <em>Eight Ball Pool</em>, it was clear that a 2D
            canvas context wouldn't work well with making the numbered balls
            roll around the canvas. Instead, we opted to use THREE.js to create
            the effect, simply by wrapping images around a three-dimensional
            sphere. This produced the graphics showcased in the following video:
          </p>
          {/*YouTube*/}
          ...
          <p>
            ...
            , a{" "}
            <a href="https://threejs.org/docs/#api/en/scenes/Scene">scene</a>,
            and a{" "}
