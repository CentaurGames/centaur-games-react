      ...
      <div className="blog-text">
        <div className="sub-paragraph">
          <p style={{ marginBottom: "40px" }}>
            In this post we will create two-dimensional flames like the one
            below:
          </p>
          ...
          <p style={{ marginTop: "40px" }}>
            ...
            addition to a globally-defined angular dispersion <em>φ</em> and
            flame height <em>h</em> both of which are the same for all flames,
            we can define some other useful variables as follows:
          </p>
          <ol className="bulleted-list">
            <li>
              ...
              animation. These points will be called Left, Right, Top and
              Bottom.
            </li>
            <li>
          ...
          <p>
            We <em>step forward</em> a single point on the flame by performing
          ...
          <ol className="bulleted-list">
            <li>
              If the Top point is not in the bottom quarter of the canvas, we
              step forward the Left, Right, and Bottom points.
            </li>
            <li>
          ...
          <ol className="bulleted-list">
            <li>
              ...
               centered at the Bottom point, with inner radius 0 and outer
              radius 2 <em>h</em>.
            </li>
            <li>
          ...
          <p>
            This technique will create a realistic-looking fire in two
            dimensions. In the{" "}
