    ...
    return (
      <div className="blog-text">
        <p className="sub-paragraph">
          ...
          This post will lay out the physics of billiard balls in as simple of a
          way as possible. There will be no code in this post. For simplicity,
          we will focus only on two pool balls colliding elastically without the
          presence of friction - a realistic enough scenario for any game. The
          techniques presented in this blog are showcased in the video below:
        </p>
        {/*YouTube*/}
        ...
        <p className="sub-paragraph">
          <Latex>
            Since our pool balls are confined to move along the plane of the
            table (i.e. they aren't floating through the air), they have freedom
            to move in two dimensions. In addition, we have the good fortune
            that the balls are the same mass, which simplifies some
            calculations.
          </Latex>
        </p>
        <p className="sub-paragraph">
          <Latex>
            ...
            velocity $\vec \mathit v_1$, while Ball 2 is moving with some
        ...
        <p className="sub-paragraph">
          <Latex>
            ...
            collision, and the $\vec \mathit s$ vectors represent the balls
            after the collision. Note that all of the laws of physics we are
            used to are still upheld in this frame of reference, and we can
            switch back to our $\vec \mathit v$ and $\vec \mathit u$ values
        ...
        <p className="sub-paragraph">
          <Latex>
            ...
            $ \vec \mathit s_2$. So far we have used three conservation
        ...
        <p className="sub-paragraph">
          <Latex>
            ...
            to be perpendicular to the plane of the table and passing through
            the center of Ball 1. We will ignore the spin of the ball and will
            instead represent angular momentum by the expression $m \vec \mathit
            v \times \vec \mathit r$, where $\vec \mathit v$ is the velocity of
            the ball in question and $\vec \mathit r$ is the displacement vector
            from the ball to the axis of rotation. Since Ball 1 is located on
            the axis of rotation, $\vec \mathit r$ is zero for Ball 1 both
            before and after the collision; hence its angular momentum is zero
        ...
        <p className="sub-paragraph">
          <Latex>
            ...
            great use when making our AI in the next post: if Ball 2 is
