      ...
      <div className="blog-text">
        <div className="sub-paragraph">
          ...
          <p style={{ marginTop: "40px", marginBottom: "40px" }}>
            ...
            requiring a different viewing angle will not be able to get one
            using this method alone. In this post we will expand upon our
            technique to create a three-dimensional flame like the one below:
          </p>
          <img src={Flames3D} width="40" height="40" />
          <p style={{ marginTop: "40px" }}>
            This effect is used in <em>Brimstone</em> to make the flames appear
            to come out of the page, and may be used in any birds-eye platformer
