...
var context, ballContext, tableContext, cueContext, cursorContext, imageContext;
...
function rescaleCanvases() {
  ...
  tableCanvas.style.left = "0px";
  tableCanvas.style.top = "0px";
  cursorCanvas.style.left = "0px";
  cursorCanvas.style.top = "0px";
  cueCanvas.style.left = "0px";
  cueCanvas.style.top = "0px";
  imageCanvas.style.left = "0px";
  imageCanvas.style.top = "0px";
  var rect = tableCanvas.getBoundingClientRect();
  var x0 = rect.left;
  ...
  cursorCanvas.width = Math.round(700 * scale);
  cursorCanvas.height = Math.round(420 * scale);
...
function run() {
  ...
  cursorContext.fillRect(0, 0, 700, 420);
  drawTable();
  if (!areImagesLoaded) {
    drawCueImage();
  } else {
...
function mouseMotionDetector(evt) {
  ...
  var scale = 700 / cursorCanvas.width;
  //clear previous cue drawings
  phi = Math.atan2(ys[0] + 30 - y * scale, xs[0] + 30 - x * scale);
  drawCue();
}
...
function mouseUp(evt) {
  ...
  cueTimer = setInterval(function () {
    if (distanceFromCueToBall >= r) {
      ...
      cursorContext.clearRect(0, 0, 700, 420);
...
function drawCue() {
  ...
  cursorContext.clearRect(0, 0, 700, 420);
  cursorContext.save();
  cursorContext.translate(xs[0] + 30, ys[0] + 30);
