...
var context, tableContext, cueContext, cursorContext, imageContext, floorContext, scoreContext, shinyContext;
...
var scene, camera, renderer, spheres = new Array(16);
...
export class EightBallPool extends React.Component {
    ...
    render() {
        return (
            ...
            <canvas id ="ballCanvas" width="800" height="520" style={{position: "absolute", top: "0", left: "0", zIndex: 4, border: "0px solid black"}} />
            <canvas id ="shinyCanvas" width="800" height="520" style={{position: "absolute", top: "0", left: "0", zIndex: 5, border: "0px solid black"}} />
            ...
            <canvas id ="cursorCanvas" width="800" height="520" style={{position: "absolute", top: "0", left: "0", zIndex: 6, border: "0px solid black"}} />
