...
var ignoreClicks = 0;
var score = 0;
var isPingAudioLoaded = 0, isPingAudioLoading = 0, isExplosionAudioLoaded = 0, isExplosionAudioLoading = 0, isIOS, isMobile;
...
function createRaceTrack() {
	...
	trackContext.closePath();
	trackContext.fill();
	grad = trackContext.createRadialGradient(trackCanvas.width/2,trackCanvas.height/2,r6,trackCanvas.width/2,trackCanvas.height/2,r5);
...
export class RocketRacers extends React.Component {
    componentDidMount() {
    ...
    render() {
        return (
            ...
            <canvas id ="trackCanvas" width="700" height="700" style={{position: "absolute", top: "0", left: "0", zIndex: 2, border: "0px solid black"}} />
            <canvas id ="carCanvas" width="110" height="100" style={{position: "absolute", top: "0", left: "0", zIndex: 3, border: "0px solid black"}} />
            <canvas id ="imageCanvas" width="100" height="100" style={{position: "absolute", top: "100", left: "100", zIndex: 1, border: "0px solid black"}} />
            <canvas id ="screenCanvas" width="700" height="700" style={{position: "absolute", top: "0", left: "0", zIndex: 4, border: "0px solid black"}} />      
            </div>
        );
    }
}
