...
var playerX, playerVX = 15, dumplingX = new Array(numberOfDumplings), dumplingY = new Array(numberOfDumplings), dumplingVY = 3, playerWidth = temporaryBowlImage.width;
...
function render() {
	...
	for (var i = 0; i < numberOfDumplings; i++) {
		if (dumplingY[i] < canvasHeight) {
			dumplingContext.drawImage(dumplingImage,dumplingX[i]-20,dumplingY[i]-40);
		} else {
			dumplingContext.drawImage(dumplingImage,0,0,40,40,dumplingX[i]-20,dumplingY[i]-40,40,canvasHeight-dumplingY[i]+40);
		}
	}
}
...
export class LumpyDumplings3 extends React.Component {
    ...
    render() {
        return (
            <div>
            <canvas id="scrollPreventCanvas" width="1136" height="640" style={{position: "absolute", top: "10", left: "10", zIndex: 0, border: "0px solid black"}} />
            <canvas id="imgCanvas" width="40" height="40" style={{position: "absolute", top: "10", left: "10", zIndex: 1, border: "0px solid black"}} />
            <canvas id="bkgrndCanvas" width="1136" height="640" style={{position: "absolute", top: "10", left: "10", zIndex: 2, border: "0px solid black"}} />
            <canvas id="dumplingCanvas" width="1136" height="640" style={{position: "absolute", top: "10", left: "10", zIndex: 3, border: "0px solid black"}} />
            <canvas id="scrCanvas" width="1136" height="640" style={{position: "absolute", top: "10", left: "10", zIndex: 4, border: "0px solid black"}} />
            </div>
        );
    }
}
