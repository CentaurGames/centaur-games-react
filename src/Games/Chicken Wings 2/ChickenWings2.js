...
import {treeDataURL, mushroomDataURL, eggDataURL, replayDataURL, scoreDataURL} from "./ChickenWings2ImageSources";
...
var backgroundAudioContext, backgroundBuffer,  backgroundAudioVolume, isAudioLoaded = 0, isAudioLoading = 0, isIOS = 0, isMobile = 0;
...
export class ChickenWings2 extends React.Component {
    componentDidMount() {
...
export {ChickenWings2 as default};