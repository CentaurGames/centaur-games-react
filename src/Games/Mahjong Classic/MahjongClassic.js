			...
			for (var i = 0; i < numX; i++) {
				if (grid[i][j][k] > -1) {
					...
					if (isClickable(i,j,k)) {
						tileContext.drawImage(highlightedTiles[grid[i][j][k]],i*tileWidth-k*tileDepth,j*tileHeight-k*tileDepth);
					} else {
						tileContext.drawImage(shadedTiles[grid[i][j][k]],i*tileWidth-k*tileDepth,j*tileHeight-k*tileDepth);
					}
					if (isSelected && selectionI === i && selectionJ === j && selectionK === k) {
						tileContext.drawImage(tileBorderImage,i*tileWidth-k*tileDepth,j*tileHeight-k*tileDepth);
					}
				}
			}
		}
...
export class MahjongClassic extends React.Component {
    ...
    render() {
        return (
            <div>
                <canvas ref="scrollPreventCanvas" width="40" height="40" style={{position: "absolute", top: "0", left: "0", zIndex: 4, border: "0px solid black"}} />
                <canvas ref="imageCanvas" width="40" height="40" style={{position: "absolute", top: "0", left: "0", zIndex: 0, border: "0px solid black"}} />
                <canvas ref="backgroundCanvas" width="1050" height="700" style={{position: "absolute", top: "0", left: "0", zIndex: 1, border: "0px solid black"}} />
                <canvas ref="tileCanvas" width="1050" height="700" style={{position: "absolute", top: "0", left: "0", zIndex: 2, border: "0px solid black"}} />
                <canvas ref="scoreCanvas" width="1050" height="700" style={{position: "absolute", top: "0", left: "0", zIndex: 3, border: "0px solid black"}} />
            </div>
        );
    }
}