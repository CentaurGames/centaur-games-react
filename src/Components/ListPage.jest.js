...
describe("ListPage component", () => {
    ...
    it.each(Object.keys(LIST_PAGE_META_INFO).filter((pageName) => !["iOS", "Android", "Blog"].includes(pageName)))("displays %s correctly", (pageName) => {
        ...
        const iconUrls = getAllByTestId("icon").map(icon => icon.getAttribute("href"));
