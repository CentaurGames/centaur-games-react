    ...
    return (
        <div className="privacy-policy">
            <div className="privacy-policy-about-us">
                {/*Privacy Policy*/}
                <div>
                    <a href={BASE_URL + "?pageType=privacy"} className="privacy-policy-link" target="_blank" >
                        PRIVACY POLICY
                    </a>
                </div>
                {/*About Us*/}
                <div>
                    <a href={BASE_URL + "?pageType=about"} className="privacy-policy-link" target="_blank" >
                        ABOUT US
                    </a>
                </div>
            </div>
