  ...
  render() {
    ...
    return (
      <div>
        ...
        {/*Big icon*/}
        <a href={BASE_URL + "?pageType=game&pageName=" + this.props.game} target="_blank" >
            <img src={GAME_META_INFO[this.props.game].largeImageURL} className="large-icon" />
        ...
        <div className="app-icon">
            <a href={GAME_META_INFO[this.props.game].iosURL} className="ios-app-link" target="_blank" >
            <img src={AppStoreImage} className="ios-app-icon" />
            </a>
            <a href={GAME_META_INFO[this.props.game].androidURL} className="android-app-link" target="_blank" >
        ...
        <div className="recommended-games">
            <IconLandingPage game={GAME_META_INFO[this.props.game].recommendedGames[0]} />
            <IconLandingPage game={GAME_META_INFO[this.props.game].recommendedGames[1]} />
            <IconLandingPage game={GAME_META_INFO[this.props.game].recommendedGames[2]} />
            <IconLandingPage game={GAME_META_INFO[this.props.game].recommendedGames[3]} />
        </div>
        ...
        {GAME_META_INFO[this.props.game].screenshotImages && (
          <div className="landing-page__screenshot-slider">
            ...
            <Carousel>
              {GAME_META_INFO[this.props.game].screenshotImages.map(screenshotImage => (
                <Carousel.Item key={screenshotImage}>
                  <img width={450} height={450} src={screenshotImage} className="rounded mx-auto d-block img-fluid" />
                </Carousel.Item>
              ))}
            </Carousel>
          </div>
